...
public class CreateNewLeadBySelectingDifferentRatingDropDown_Test {
    
  @Test
     public  void Testrating () throws IOException, InterruptedException 
	{ 
		...
		WebElement wb4 = driver.findElement(By.name("rating"));
         ...
         Thread.sleep(3000);
         s4.selectByValue("Acquired");
         Thread.sleep(3000);
         s4.selectByValue("Market Failed");
         Thread.sleep(3000);
         s4.selectByValue("Project Cancelled");
         Thread.sleep(3000);
         s4.selectByValue("Shutdown");
         Thread.sleep(3000);
